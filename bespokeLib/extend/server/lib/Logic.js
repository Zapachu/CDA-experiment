        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        _a = this.game.params, group = _a.group, groupsParams = _a.groupsParams;
                        this.groupsLogic = Array(group).fill(null).map(function (_, i) {
                            return new _this.GroupLogic(groupsParams[i], new Group.StateManager(i, _this.stateManager));
                        });
