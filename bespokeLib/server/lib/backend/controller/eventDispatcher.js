...
var EventDispatcher = /** @class */ (function () {
    ...
    EventDispatcher.startGameSocket = function (server) {
        var socketIOServer = service_1.EventIO.initSocketIOServer(server, this.subscribeOnConnection);
        service_1.EventIO.initRobotIOServer(this.subscribeOnConnection);
