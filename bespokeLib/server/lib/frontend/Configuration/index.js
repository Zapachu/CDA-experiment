...
var Configuration = /** @class */ (function (_super) {
    ...
    Configuration.prototype.componentDidMount = function () {
    ...
    Configuration.prototype.render = function () {
        var _a = this, lang = _a.lang, _b = _a.props, history = _b.history, gameId = _b.match.params.gameId, gameTemplate = _b.gameTemplate, _c = _a.state, loading = _c.loading, game = _c.game;
        if (loading) {
        ...
        return React.createElement("section", { className: style.configuration },
            ...
            React.createElement("ul", { className: style.phaseList },
                ...
                React.createElement("li", { style: { margin: '2rem auto 0' } },
                    React.createElement(component_1.Button, { width: component_1.ButtonProps.Width.medium, color: component_1.ButtonProps.Color.blue, label: lang.playRoom, onClick: function () { return history.push("/play/" + gameId); } }))));
    };
