...
var EventIO = /** @class */ (function () {
    ...
    EventIO.initSocketIOServer = function (server, subscribeOnConnection) {
        ...
        this.socketIOServer.on(share_1.SocketEvent.connection, function (connection) { return __awaiter(_this, void 0, void 0, function () {
            var _a, _b, token, gameId, _c, _d, userId, linkerActor, sessionID, game, actor, user, _e, id, mobile, name_1, role, headimg, stuNum;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 2:
                        _e = _f.sent(), id = _e.id, mobile = _e.mobile, name_1 = _e.name, role = _e.role, headimg = _e.headimg, stuNum = _e.stuNum;
                        user = { id: id, mobile: mobile, name: name_1, role: role, headimg: headimg, stuNum: stuNum };
                        _f.label = 3;
                    case 3:
