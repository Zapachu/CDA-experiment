...
export class QCloudSMS {
  ...
  static singleSenderWithParam(nationCode: NationCode, phoneNumber: string, templateId: string, params: Array<string>) {
    return new Promise<boolean>(resolve => {
      this.singleSender.sendWithParam(
        nationCode,
        phoneNumber,
        templateId,
        params,
        elfSetting.qCloudSMS.smsSign,
        '',
        '',
        (err: Error, res, resData) => {
