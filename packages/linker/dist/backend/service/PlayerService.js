...
var PlayerService = /** @class */ (function () {
    ...
    PlayerService.savePlayer = function (gameId, userId) {
    ...
    PlayerService.findPlayerId = function (gameId, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var player;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    PlayerService.getPlayers = function (gameId) {
        return __awaiter(this, void 0, void 0, function () {
            var players;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, players.map(function (_a) {
                                ...
                                return ({ playerId: id, userId: userId.id, name: userId.name });
                            })];
                }
            });
        });
