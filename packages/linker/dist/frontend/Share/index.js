...
var Share = /** @class */ (function (_super) {
    ...
    Share.prototype.render = function () {
        ...
        return React.createElement("section", { className: style.share },
            React.createElement(component_2.Breadcrumb, { history: history, links: [
                    { label: lang.info, to: "/info/" + gameId },
                    { label: lang.console, to: "/play/" + gameId }
                ] }),
            React.createElement("div", { className: style.shareContent },
                ...
                React.createElement("div", { className: style.qrCodeWrapper, onClick: function () { return history.push("/info/" + gameId); } },
                    React.createElement(QrCode, { size: 256, value: location.origin + "/" + linker_share_1.config.rootName + "/info/" + gameId })),
