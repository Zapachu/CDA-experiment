...
var Join = /** @class */ (function (_super) {
    ...
    Join.prototype.joinGame = function (code) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, lang, history, res;
    ...
    Join.prototype.render = function () {
        ...
        return React.createElement("section", { className: style.Join },
            ...
            React.createElement(component_2.CodePanel, { number: 6, onFinish: function (code) { return _this.joinGame(code); }, goBack: function () { return _this.props.history.goBack(); } }));
    };
    return Join;
}(React.Component));
exports.Join = Join;
