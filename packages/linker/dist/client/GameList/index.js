...
exports.GameList = function (_a) {
    ...
    return React.createElement("section", { className: style.gameList },
        React.createElement(antd_1.Button, { style: { margin: '2rem' }, type: 'primary', onClick: function () { return history.push('/join'); } }, lang.join),
        React.createElement(antd_1.List, { grid: { gutter: 24, xl: 4, md: 3, sm: 2, xs: 1 }, dataSource: gameList, renderItem: function (_a) {
                ...
                return React.createElement(ListItem, { key: id },
                    React.createElement("section", { className: style.gameItem, onClick: function () { return history.push(id ? "/info/" + id : '/baseInfo'); } },
