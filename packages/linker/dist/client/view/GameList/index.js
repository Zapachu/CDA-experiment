...
exports.GameList = function (_a) {
    ...
    var lang = util_1.Lang.extractLang({
        join: ['快速加入', 'Join'],
        title: ['标题', 'Title'],
        desc: ['详情', 'Description'],
        cancel: ['取消', 'Cancel'],
    ...
    return react_1.default.createElement("section", { className: style.gameList },
        react_1.default.createElement(antd_1.Button, { style: { margin: '2rem' }, type: 'primary', onClick: function () { return history.push('/join'); } }, lang.join),
        react_1.default.createElement(antd_1.List, { grid: { gutter: 24, xl: 4, md: 3, sm: 2, xs: 1 }, dataSource: gameList, renderItem: function (_a) {
        ...
        react_1.default.createElement(antd_1.Pagination, __assign({}, {
            total: count,
            pageSize: 11,
