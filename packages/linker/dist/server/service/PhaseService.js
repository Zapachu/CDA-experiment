...
var PhaseService = /** @class */ (function () {
    ...
    PhaseService.getPhaseTemplates = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            var phaseTemplates, registeredPhaseKeys, registeredPhaseKeys_1, registeredPhaseKeys_1_1, key, _a, _b, _c, _d, e_1_1;
            var e_1, _e;
                ...
                switch (_f.label) {
                    ...
                    case 9:
                        if (!setting_1.elfSetting.inProductEnv || !userId) {
                            return [2 /*return*/, phaseTemplates];
                        }
                        return [2 /*return*/, new Promise(function (resolve) {
                                rpc_1.getAdminService().getAuthorizedTemplates({ userId: userId }, function (err, response) {
                                    ...
                                    resolve(phaseTemplates.filter(function (_a) {
