...
var DiffGameStateSynchronizer = /** @class */ (function (_super) {
    __extends(DiffGameStateSynchronizer, _super);
    function DiffGameStateSynchronizer() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DiffGameStateSynchronizer.prototype.syncClientState = function (wholeState) {
    ...
    return DiffGameStateSynchronizer;
}(BaseSynchronizer_1.GameStateSynchronizer));
exports.DiffGameStateSynchronizer = DiffGameStateSynchronizer;
var DiffPlayerStateSynchronizer = /** @class */ (function (_super) {
    __extends(DiffPlayerStateSynchronizer, _super);
    function DiffPlayerStateSynchronizer() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DiffPlayerStateSynchronizer.prototype.syncClientState = function (wholeState) {
        return __awaiter(this, void 0, void 0, function () {
            var gameState, state, stateCopy, stateChanges;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return DiffPlayerStateSynchronizer;
}(BaseSynchronizer_1.PlayerStateSynchronizer));
exports.DiffPlayerStateSynchronizer = DiffPlayerStateSynchronizer;
//# sourceMappingURL=DiffSynchronizer.js.map