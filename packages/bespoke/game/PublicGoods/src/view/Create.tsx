...
import {Core, Label, RangeInput, Input} from 'bespoke-client-util'
...
export class Create extends Core.Create<ICreateParams, FetchType, ICreateState> {
    ...
    edit = () => {
        ...
        setParams({round, groupSize, initialFunding, returnOnInvestment})
            ...
            <ul className={style.configFields}>
                ...
                <li>
                    ...
                    <Input value={returnOnInvestment}
                           onChange={(e) => this.setState({returnOnInvestment: parseFloat(e.target.value)})}/>
                </li>
            </ul>
