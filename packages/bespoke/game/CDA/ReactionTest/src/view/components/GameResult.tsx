...
import {FrameEmitter, IGame, Button} from 'bespoke-client-util'
...
const GameResult = ({correctNumber, point, game, frameEmitter}: Props) => {
  return <section className={style.result}>
            <p>Reaction测试，您一共答对了：<em>{correctNumber}</em> 个</p>
