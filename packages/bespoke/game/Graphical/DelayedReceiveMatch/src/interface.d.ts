...
export interface ICreateParams {
    ...
    /** CreateParams groupPPs */
    groupPPs?: (CreateParams.IGroupPP[]|null);
...
export class CreateParams implements ICreateParams {
    ...
    /** CreateParams groupPPs. */
    public groupPPs: CreateParams.IGroupPP[];
...
export namespace CreateParams {
    ...
    /** Properties of a GroupPP. */
    interface IGroupPP {

        /** GroupPP roundPPs */
        roundPPs?: (CreateParams.GroupPP.IRoundPP[]|null);
    }

    /** Represents a GroupPP. */
    class GroupPP implements IGroupPP {

        /**
         * Constructs a new GroupPP.
         * @param [properties] Properties to set
         */
        constructor(properties?: CreateParams.IGroupPP);

        /** GroupPP roundPPs. */
        public roundPPs: CreateParams.GroupPP.IRoundPP[];

        /**
         * Creates a new GroupPP instance using the specified properties.
         * @param [properties] Properties to set
         * @returns GroupPP instance
         */
        public static create(properties?: CreateParams.IGroupPP): CreateParams.GroupPP;

        /**
         * Encodes the specified GroupPP message. Does not implicitly {@link CreateParams.GroupPP.verify|verify} messages.
         * @param message GroupPP message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encode(message: CreateParams.IGroupPP, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
         * Encodes the specified GroupPP message, length delimited. Does not implicitly {@link CreateParams.GroupPP.verify|verify} messages.
         * @param message GroupPP message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encodeDelimited(message: CreateParams.IGroupPP, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
         * Decodes a GroupPP message from the specified reader or buffer.
         * @param reader Reader or buffer to decode from
         * @param [length] Message length if known beforehand
         * @returns GroupPP
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): CreateParams.GroupPP;

        /**
         * Decodes a GroupPP message from the specified reader or buffer, length delimited.
         * @param reader Reader or buffer to decode from
         * @returns GroupPP
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): CreateParams.GroupPP;

        /**
         * Verifies a GroupPP message.
         * @param message Plain object to verify
         * @returns `null` if valid, otherwise the reason why it is not
         */
        public static verify(message: { [k: string]: any }): (string|null);
        ...
        /**
         * Creates a GroupPP message from a plain object. Also converts values to their respective internal types.
         * @param object Plain object
         * @returns GroupPP
         */
        public static fromObject(object: { [k: string]: any }): CreateParams.GroupPP;

        /**
         * Creates a plain object from a GroupPP message. Also converts values to other types if specified.
         * @param message GroupPP
         * @param [options] Conversion options
         * @returns Plain object
         */
        public static toObject(message: CreateParams.GroupPP, options?: $protobuf.IConversionOptions): { [k: string]: any };

        /**
         * Converts this GroupPP to JSON.
         * @returns JSON object
         */
        public toJSON(): { [k: string]: any };
    }
    ...
    namespace GroupPP {
        ...
        /** Properties of a RoundPP. */
        interface IRoundPP {

            /** RoundPP playerPPs */
            playerPPs?: (CreateParams.GroupPP.RoundPP.IPlayerPP[]|null);
        }

        /** Represents a RoundPP. */
        class RoundPP implements IRoundPP {

            /**
             * Constructs a new RoundPP.
             * @param [properties] Properties to set
             */
            constructor(properties?: CreateParams.GroupPP.IRoundPP);

            /** RoundPP playerPPs. */
            public playerPPs: CreateParams.GroupPP.RoundPP.IPlayerPP[];

            /**
             * Creates a new RoundPP instance using the specified properties.
             * @param [properties] Properties to set
             * @returns RoundPP instance
             */
            public static create(properties?: CreateParams.GroupPP.IRoundPP): CreateParams.GroupPP.RoundPP;

            /**
             * Encodes the specified RoundPP message. Does not implicitly {@link CreateParams.GroupPP.RoundPP.verify|verify} messages.
             * @param message RoundPP message or plain object to encode
             * @param [writer] Writer to encode to
             * @returns Writer
             */
            public static encode(message: CreateParams.GroupPP.IRoundPP, writer?: $protobuf.Writer): $protobuf.Writer;

            /**
             * Encodes the specified RoundPP message, length delimited. Does not implicitly {@link CreateParams.GroupPP.RoundPP.verify|verify} messages.
             * @param message RoundPP message or plain object to encode
             * @param [writer] Writer to encode to
             * @returns Writer
             */
            public static encodeDelimited(message: CreateParams.GroupPP.IRoundPP, writer?: $protobuf.Writer): $protobuf.Writer;

            /**
             * Decodes a RoundPP message from the specified reader or buffer.
             * @param reader Reader or buffer to decode from
             * @param [length] Message length if known beforehand
             * @returns RoundPP
             * @throws {Error} If the payload is not a reader or valid buffer
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): CreateParams.GroupPP.RoundPP;

            /**
             * Decodes a RoundPP message from the specified reader or buffer, length delimited.
             * @param reader Reader or buffer to decode from
             * @returns RoundPP
             * @throws {Error} If the payload is not a reader or valid buffer
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): CreateParams.GroupPP.RoundPP;

            /**
             * Verifies a RoundPP message.
             * @param message Plain object to verify
             * @returns `null` if valid, otherwise the reason why it is not
             */
            public static verify(message: { [k: string]: any }): (string|null);
            ...
            /**
             * Creates a RoundPP message from a plain object. Also converts values to their respective internal types.
             * @param object Plain object
             * @returns RoundPP
             */
            public static fromObject(object: { [k: string]: any }): CreateParams.GroupPP.RoundPP;

            /**
             * Creates a plain object from a RoundPP message. Also converts values to other types if specified.
             * @param message RoundPP
             * @param [options] Conversion options
             * @returns Plain object
             */
            public static toObject(message: CreateParams.GroupPP.RoundPP, options?: $protobuf.IConversionOptions): { [k: string]: any };

            /**
             * Converts this RoundPP to JSON.
             * @returns JSON object
             */
            public toJSON(): { [k: string]: any };
        }
        ...
        namespace RoundPP {
            ...
            /** Properties of a PlayerPP. */
            interface IPlayerPP {

                /** PlayerPP privatePrices */
                privatePrices?: (number[]|null);
            }

            /** Represents a PlayerPP. */
            class PlayerPP implements IPlayerPP {

                /**
                 * Constructs a new PlayerPP.
                 * @param [properties] Properties to set
                 */
                constructor(properties?: CreateParams.GroupPP.RoundPP.IPlayerPP);

                /** PlayerPP privatePrices. */
                public privatePrices: number[];

                /**
                 * Creates a new PlayerPP instance using the specified properties.
                 * @param [properties] Properties to set
                 * @returns PlayerPP instance
                 */
                public static create(properties?: CreateParams.GroupPP.RoundPP.IPlayerPP): CreateParams.GroupPP.RoundPP.PlayerPP;

                /**
                 * Encodes the specified PlayerPP message. Does not implicitly {@link CreateParams.GroupPP.RoundPP.PlayerPP.verify|verify} messages.
                 * @param message PlayerPP message or plain object to encode
                 * @param [writer] Writer to encode to
                 * @returns Writer
                 */
                public static encode(message: CreateParams.GroupPP.RoundPP.IPlayerPP, writer?: $protobuf.Writer): $protobuf.Writer;

                /**
                 * Encodes the specified PlayerPP message, length delimited. Does not implicitly {@link CreateParams.GroupPP.RoundPP.PlayerPP.verify|verify} messages.
                 * @param message PlayerPP message or plain object to encode
                 * @param [writer] Writer to encode to
                 * @returns Writer
                 */
                public static encodeDelimited(message: CreateParams.GroupPP.RoundPP.IPlayerPP, writer?: $protobuf.Writer): $protobuf.Writer;

                /**
                 * Decodes a PlayerPP message from the specified reader or buffer.
                 * @param reader Reader or buffer to decode from
                 * @param [length] Message length if known beforehand
                 * @returns PlayerPP
                 * @throws {Error} If the payload is not a reader or valid buffer
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): CreateParams.GroupPP.RoundPP.PlayerPP;

                /**
                 * Decodes a PlayerPP message from the specified reader or buffer, length delimited.
                 * @param reader Reader or buffer to decode from
                 * @returns PlayerPP
                 * @throws {Error} If the payload is not a reader or valid buffer
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): CreateParams.GroupPP.RoundPP.PlayerPP;

                /**
                 * Verifies a PlayerPP message.
                 * @param message Plain object to verify
                 * @returns `null` if valid, otherwise the reason why it is not
                 */
                public static verify(message: { [k: string]: any }): (string|null);
                ...
                /**
                 * Creates a PlayerPP message from a plain object. Also converts values to their respective internal types.
                 * @param object Plain object
                 * @returns PlayerPP
                 */
                public static fromObject(object: { [k: string]: any }): CreateParams.GroupPP.RoundPP.PlayerPP;

                /**
                 * Creates a plain object from a PlayerPP message. Also converts values to other types if specified.
                 * @param message PlayerPP
                 * @param [options] Conversion options
                 * @returns Plain object
                 */
                public static toObject(message: CreateParams.GroupPP.RoundPP.PlayerPP, options?: $protobuf.IConversionOptions): { [k: string]: any };

                /**
                 * Converts this PlayerPP to JSON.
                 * @returns JSON object
                 */
                public toJSON(): { [k: string]: any };
            }
...
export interface IPlayerState {
    ...
    /** PlayerState rounds */
    rounds?: (PlayerState.IRound[]|null);
}
...
export class PlayerState implements IPlayerState {
    ...
    /** PlayerState rounds. */
    public rounds: PlayerState.IRound[];
...
export namespace PlayerState {
    ...
    class Round implements IRound {
         ...
         * @param [properties] Properties to set
         */
        constructor(properties?: PlayerState.IRound);
         ...
         */
        public static create(properties?: PlayerState.IRound): PlayerState.Round;

        /**
         * Encodes the specified Round message. Does not implicitly {@link PlayerState.Round.verify|verify} messages.
         * @param message Round message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encode(message: PlayerState.IRound, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
         * Encodes the specified Round message, length delimited. Does not implicitly {@link PlayerState.Round.verify|verify} messages.
         * @param message Round message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encodeDelimited(message: PlayerState.IRound, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): PlayerState.Round;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): PlayerState.Round;
         ...
         * @returns Round
         */
        public static fromObject(object: { [k: string]: any }): PlayerState.Round;
         ...
         * @returns Plain object
         */
        public static toObject(message: PlayerState.Round, options?: $protobuf.IConversionOptions): { [k: string]: any };
