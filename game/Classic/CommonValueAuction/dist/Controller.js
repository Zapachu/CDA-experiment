...
var Controller = /** @class */ (function (_super) {
    ...
    Controller.prototype.playerMoveReducer = function (actor, type, params, cb) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, groupSize, round, positions, mode, winnerNumber, playerState, gameState, playerStates, _b, groupIndex, group, groupIndex_1, positionIndex, groupState_1, rounds, roundIndex_1, playerStatus_1, groupPlayerStates_1, highestSorts, winners_1, prices, median_1, i, newRoundTimer_1, newRoundInterval_1;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this.game.params, groupSize = _a.groupSize, round = _a.round, positions = _a.positions, mode = _a.mode, winnerNumber = _a.winnerNumber;
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 9];
                    case 5:
                        groupIndex_1 = playerState.groupIndex, positionIndex = playerState.positionIndex, groupState_1 = gameState.groups[groupIndex_1], rounds = groupState_1.rounds, roundIndex_1 = groupState_1.roundIndex, playerStatus_1 = rounds[roundIndex_1].playerStatus, groupPlayerStates_1 = Object.values(playerStates).filter(function (s) { return s.groupIndex === groupIndex_1; });
                        playerStatus_1[positionIndex] = config_1.PlayerStatus.shouted;
                        playerState.prices[roundIndex_1] = params.price;
                        if (!playerStatus_1.every(function (status) { return status === config_1.PlayerStatus.shouted; })) return [3 /*break*/, 9];
                        switch (mode) {
                            case 0: {
                                highestSorts = groupPlayerStates_1.sort(function (a, b) { return b.prices[roundIndex_1] - a.prices[roundIndex_1]; });
                                highestSorts.map(function (p, i) {
                                    if (i < winnerNumber) {
                                        playerStatus_1[i] = config_1.PlayerStatus.won;
                                        p.profits[roundIndex_1] = p.privatePrices[roundIndex_1] - p.prices[roundIndex_1];
                                    }
                                });
                                break;
                            }
                            case 1: {
                                winners_1 = 0;
                                prices = groupPlayerStates_1.map(function (p) { return p.prices[roundIndex_1]; });
                                median_1 = (prices[(prices.length - 1) >> 1] + prices[prices.length >> 1]) / 2;
                                groupPlayerStates_1.map(function (p, i) {
                                    if (p.prices[roundIndex_1] > median_1 && winners_1 < winnerNumber) {
                                        winners_1++;
                                        playerStatus_1[i] = config_1.PlayerStatus.won;
                                        p.profits[roundIndex_1] = p.privatePrices[roundIndex_1] - p.prices[roundIndex_1];
                                    }
