...
class GroupCreate extends Extend.Group.Create<ICreateParams> {
    ...
    render() {
        const {props: {groupParams: {round, t, buyPriceRange, sellPriceRange}, setGroupParams}, lang} = this;
        return <Row>
