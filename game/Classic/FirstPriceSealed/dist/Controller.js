...
var Controller = /** @class */ (function (_super) {
    ...
    Controller.prototype.playerMoveReducer = function (actor, type, params, cb) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, groupSize, round, positions, playerState, gameState, playerStates, _b, groupIndex, group, groupIndex_1, positionIndex, groupState_1, rounds, roundIndex_1, playerStatus, groupPlayerStates_1, i, newRoundTimer_1, newRoundInterval_1;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 5:
                        ...
                        groupPlayerStates_1.sort(function (s1, s2) { return s2.prices[roundIndex_1] - s1.prices[roundIndex_1]; });
                        groupPlayerStates_1[0].profits[roundIndex_1] = groupPlayerStates_1[0].privatePrices[roundIndex_1] - groupPlayerStates_1[1].prices[roundIndex_1];
