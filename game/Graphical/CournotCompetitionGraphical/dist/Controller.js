...
var Controller = /** @class */ (function (_super) {
    ...
    Controller.prototype.playerMoveReducer = function (actor, type, params, cb) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, groupSize, round, quota, playerState, gameState, playerStates, groupIndex, group, groupIndex, positionIndex, _b, rounds, roundIndex, groupIndex_1, positionIndex, groupState_1, rounds, roundIndex_1, playerStatus, groupPlayerStates_1, groupIndex_2, positionIndex, groupState, rounds, roundIndex_2, _c, playerStatus, unitPrices_1, groupPlayerStates_2;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _a = this.game.params, groupSize = _a.groupSize, round = _a.round, quota = _a.quota;
                    ...
                    case 3:
                        ...
                        switch (type) {
                            ...
                            case config_1.MoveType.shout: {
                                ...
                                groupIndex_2 = playerState.groupIndex, positionIndex = playerState.positionIndex, groupState = gameState.groups[groupIndex_2], rounds = groupState.rounds, roundIndex_2 = groupState.roundIndex, _c = rounds[roundIndex_2], playerStatus = _c.playerStatus, unitPrices_1 = _c.unitPrices, groupPlayerStates_2 = Object.values(playerStates).filter(function (s) { return s.groupIndex === groupIndex_2; });
                                if (playerStatus[positionIndex] === config_1.PlayerStatus.shouted) {
                                    return [2 /*return*/];
                                }
                                playerStatus[positionIndex] = config_1.PlayerStatus.shouted;
                                playerState.quantities[roundIndex_2] = params.quantity;
                                if (playerStatus.every(function (status) { return status === config_1.PlayerStatus.shouted; })) {
                                    setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                                        var _a, playerA, playerB, unitPrice;
                                        return __generator(this, function (_b) {
                                            switch (_b.label) {
                                                case 0:
                                                    _a = __read(groupPlayerStates_2, 2), playerA = _a[0], playerB = _a[1];
                                                    unitPrice = quota - (playerA.quantities[roundIndex_2] + playerB.quantities[roundIndex_2]);
                                                    unitPrices_1[roundIndex_2] = unitPrice;
                                                    playerA.profits[roundIndex_2] = playerA.quantities[roundIndex_2] * unitPrice;
                                                    playerB.profits[roundIndex_2] = playerB.quantities[roundIndex_2] * unitPrice;
                                                    return [4 /*yield*/, this.stateManager.syncState()];
                                                case 1:
                                                    _b.sent();
                                                    return [2 /*return*/];
