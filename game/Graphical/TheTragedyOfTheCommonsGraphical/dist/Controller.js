...
var Controller = /** @class */ (function (_super) {
    ...
    Controller.prototype.playerMoveReducer = function (actor, type, params, cb) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, groupSize, round, fishCount, magnification, playerState, gameState, playerStates, _b, groupIndex, group, groupState, rounds, roundIndex, groupIndex_1, positionIndex, _c, rounds_1, roundIndex_1, groupIndex_2, positionIndex, groupState_1, rounds_2, roundIndex_2, playerStatus, groupPlayerStates_1, i, newRoundTimer_1, newRoundInterval_1, groupIndex_3, positionIndex, groupState_2, rounds_3, roundIndex_3, playerStatus, groupPlayerStates, lastFish, everyGet_1, i;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _a = this.game.params, groupSize = _a.groupSize, round = _a.round, fishCount = _a.fishCount, magnification = _a.magnification;
                    ...
                    case 3:
                        ...
                        switch (_b) {
                            ...
                            case config_1.MoveType.shout: return [3 /*break*/, 10];
                        }
                        return [3 /*break*/, 14];
                    case 4:
                        ...
                        rounds = groupState.rounds, roundIndex = groupState.roundIndex;
                    ...
                    case 5:
                        {
                            ...
                            _c = gameState.groups[groupIndex_1], rounds_1 = _c.rounds, roundIndex_1 = _c.roundIndex;
                            rounds_1[roundIndex_1].playerStatus[positionIndex] = config_1.PlayerStatus.prepared;
                            return [3 /*break*/, 14];
                        }
                        _d.label = 6;
                    case 6:
                        ...
                        rounds_2[roundIndex_2].playerStatus[positionIndex] = config_1.PlayerStatus.preparedNextRound;
                        if (!playerStatus.every(function (status) { return status === config_1.PlayerStatus.preparedNextRound; })) return [3 /*break*/, 9];
                        if (!(roundIndex_2 == rounds_2.length - 1)) return [3 /*break*/, 8];
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        if (!rounds_2[groupState_1.roundIndex].fishLeft) {
                                            rounds_2[groupState_1.roundIndex].fishLeft = fishCount;
                                        }
                                        return [4 /*yield*/, this.stateManager.syncState()];
                                    case 1:
                                        _a.sent();
                    ...
                    case 10:
                        groupIndex_3 = playerState.groupIndex, positionIndex = playerState.positionIndex, groupState_2 = gameState.groups[groupIndex_3], rounds_3 = groupState_2.rounds, roundIndex_3 = groupState_2.roundIndex, playerStatus = rounds_3[roundIndex_3].playerStatus, groupPlayerStates = Object.values(playerStates).filter(function (s) { return s.groupIndex === groupIndex_3; });
                        playerStatus[positionIndex] = config_1.PlayerStatus.shouted;
                        playerState.prices[roundIndex_3] = params.price;
                        playerState.profits[roundIndex_3] = params.price;
                        rounds_3[roundIndex_3].fishLeft -= params.price;
                        return [4 /*yield*/, this.stateManager.syncState()];
                    case 11:
                        _d.sent();
                        if (!playerStatus.every(function (p) { return p === config_1.PlayerStatus.shouted; })) return [3 /*break*/, 13];
                        lastFish = rounds_3[roundIndex_3].fishLeft * magnification;
                        everyGet_1 = lastFish / groupSize;
                        groupPlayerStates.map(function (p) {
                            p.profits[roundIndex_3] += parseInt(everyGet_1.toString());
                        });
                        for (i in playerStatus) {
                            playerStatus[i] = config_1.PlayerStatus.nextRound;
                        }
                        return [4 /*yield*/, this.stateManager.syncState()];
                    case 12:
                        _d.sent();
