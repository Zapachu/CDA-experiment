...
var Controller = /** @class */ (function (_super) {
    ...
    Controller.prototype.playerMoveReducer = function (actor, type, params, cb) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, groupSize, round, privatePrice, startingPrice, playerState, gameState, playerStates, groupIndex, group, groupIndex, positionIndex, _b, rounds, roundIndex, groupIndex_1, positionIndex, groupState_1, rounds_1, roundIndex_1, playerStatus_1, groupPlayerStates_1;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this.game.params, groupSize = _a.groupSize, round = _a.round, privatePrice = _a.privatePrice, startingPrice = _a.startingPrice;
                    ...
                    case 3:
                        ...
                        switch (type) {
                            case config_1.MoveType.getPosition: {
                                ...
                                playerState.privatePrices = privatePrice.map(function (v) { return +v.split(',')[playerState.positionIndex]; });
                                break;
                            }
                            ...
                            case config_1.MoveType.shout: {
                                groupIndex_1 = playerState.groupIndex, positionIndex = playerState.positionIndex, groupState_1 = gameState.groups[groupIndex_1], rounds_1 = groupState_1.rounds, roundIndex_1 = groupState_1.roundIndex, playerStatus_1 = rounds_1[roundIndex_1].playerStatus, groupPlayerStates_1 = Object.values(playerStates).filter(function (s) { return s.groupIndex === groupIndex_1; });
                                playerStatus_1[positionIndex] = config_1.PlayerStatus.shouted;
                                playerState.prices[roundIndex_1] = params.price;
                                if (playerStatus_1.every(function (status) { return status === config_1.PlayerStatus.shouted; })) {
                                    setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                                        var _a, positionIndex, prices;
                                        var _this = this;
                                        return __generator(this, function (_b) {
                                            switch (_b.label) {
                                                case 0:
                                                    _a = __read(groupPlayerStates_1.sort(function (s1, s2) { return s2.prices[roundIndex_1] - s1.prices[roundIndex_1]; }), 2), positionIndex = _a[0].positionIndex, prices = _a[1].prices;
                                                    playerStatus_1[positionIndex] = config_1.PlayerStatus.won;
                                                    playerState.profits[roundIndex_1] = prices[roundIndex_1] - startingPrice;
                                                    return [4 /*yield*/, this.stateManager.syncState()];
                                                case 1:
                                                    _b.sent();
                                                    if (roundIndex_1 == rounds_1.length - 1) {
                                                        return [2 /*return*/];
                                                    }
