...
var router = express_1.Router()
    .get(config_1.FetchRoute.getUserMobile, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var _a, userId, mobile, gameId, _b, token, actorType, _c, game, stateManager, playerState;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                _a = req.user, userId = _a._id, mobile = _a.mobile, gameId = req.params.gameId, _b = req.query, token = _b.token, actorType = _b.actorType;
                return [4 /*yield*/, server_1.BaseLogic.getLogic(gameId)];
            case 1:
                _c = _d.sent(), game = _c.game, stateManager = _c.stateManager;
                if (!(game.owner.toString() !== userId.toString())) return [3 /*break*/, 3];
                return [4 /*yield*/, stateManager.getPlayerState({ type: actorType, token: token })];
            case 2:
                playerState = _d.sent();
