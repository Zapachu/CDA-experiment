...
export const Test1 = [
  {
    desc: [{ text: '假设其他三个组员选择“2, 2, 2”' }, { text: '', br: 10 }, { text: '如果你选择“1”' }],
    questions: [
      {
  ...
  {
    desc: [{ text: '假设其他三个组员选择“2, 2, 2”' }, { text: '', br: 10 }, { text: '如果你选择“2”' }],
    questions: [
      {
        title: [{ text: '你在这一轮的收益为:' }],
        options: (displayData, d) => [
  ...
  {
    desc: [{ text: '假设其他三个组员选择“1, 1, 2”' }, { text: '', br: 10 }, { text: '如果你选择“2”' }],
    questions: [
      {
        title: [{ text: '你在这一轮的收益为:' }],
        options: (displayData, d) => [
