          ...
          <ul className={style.create}>
            ...
            <>
              <li>
                ...
                <Select value={params.mode as any} style={INPUT_STYLE} onChange={mode => setParams({ mode })}>
              ...
              <li>
                ...
                <Select value={params.min as any} style={INPUT_STYLE} onChange={min => setParams({ min })}>
                  {mins.map(({ label, value }) => (
                    <Option value={value}>{label}</Option>
                  ))}
                </Select>
              </li>
            </>
            {(['a', 'b', 'c', 'd', 'eH', 'eL', 's', 'p'] as Array<keyof ICreateParams>).map(key => (
              <li key={key}>
                <Label label={key} />
                <InputNumber
                  {...{
