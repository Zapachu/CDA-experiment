  ...
  renderContent = () => {
    ...
    switch (playerState.status) {
      ...
      case STATUS.playing: {
        ...
        return (
          <div className={style.stage}>
            ...
            <p>
              <label>你的选择是：</label>
              <Radio.Group onChange={e => this.setState({ answer: e.target.value })} value={answer}>
        ...
        return (
          <div className={style.stage}>
            ...
            <div className={style.info}>
              ...
              <Input value={key} onChange={e => this.setState({ key: e.target.value })} />
            </div>
            <Button
              onClick={() => {
      ...
      case STATUS.end: {
        return (
          <div className={style.stage}>
            <p>感谢你的选择！我们将会在未来的部分日期根据你的选择安排你和你组员的补贴方案！</p>
          </div>
        )
      }
    }
