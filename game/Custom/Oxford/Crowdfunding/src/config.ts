...
export const projectConfigs: IProjectConfig[] = [
  ...
  },
  {
    ...
    readMore:
      'This project proposes a new drug to reduce the overall risk of complications and mortality of people with Type-II Diabetes.',
    threshold: 72,
    payoff: 24,
    fundProbability: Probability.HIGH,
    successRate: 75
  ...
  },
  {
    name: 'HIV',
    readMore:
      'This project proposes a new vaccine for Human  Immunodeficiency Virus (HIV) which would  reduce the risk of transmission by 60%.',
    threshold: 72,
    payoff: 12,
    fundProbability: Probability.LOW,
    successRate: 25
