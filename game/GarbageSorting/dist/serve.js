...
var router = express_1.Router().get("/share/:gameId", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var user, gameId, userId, key, result, originalUrl, url;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                result = _a.sent();
                if (result) {
                    originalUrl = req.originalUrl.includes("?")
                        ? req.originalUrl.split("?")[0]
                        : req.originalUrl;
                    url = originalUrl.replace("/share", "/play");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, server_1.Server.newGame({
                    title: config_1.namespace + ":" + new Date().toUTCString(),
                    params: {
                        groupSize: 10
                    }
                })];
