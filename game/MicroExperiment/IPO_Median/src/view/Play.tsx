...
export const getPlay = (IPOTypeConfig: IPOTypeConfig) => ({frameEmitter, game, gameState, playerState}: Core.IPlayProps<ICreateParams, IGameState, IPlayerState, MoveType, PushType, IMoveParams, IPushParams>) => {
