...
export const Play = getPlay({
  ...
  testQuestions: [
    ...
    },
    {
      Content: ({ inputProps }) => (
        <p>
          一个股本1亿股的公司，如果今年预计利润为2亿元，其每股收益EPS=2亿/1亿=2元。如果目前股价为40元，则其市盈率：PE=
          <AntInput {...inputProps()} />
        </p>
      ),
    ...
    },
    {
      Content: ({ inputProps }) => (
        <p>
          当您们公司对股票的估值为49 元，股票的保留价格为33元是，则您的最高购买价格为
          <AntInput {...inputProps()} />
          元，最低购买价格为
          <AntInput {...inputProps()} />
    ...
    },
    {
      Content: ({ inputProps }) => (
        <div>
          ...
          <p>
            整个市场的拟购买总股数为21000，第10000股价格为100元，则成交价格为
            <AntInput {...inputProps()} />
            元。
            <br />
            A的成交数量：
      ...
      Answer: () => (
        <span>
          整个市场的拟购买总股数为21000，第10000股价格为100元，则成交价格即为第10000股股票对应的价格：100元。
    ...
    },
    {
      Content: ({ inputProps }) => (
        <div>
          ...
          <p>
            整个市场的拟购买总股数为22000，第10000股价格为48元，则成交价格为
            <AntInput {...inputProps()} />
            元。
            <br />
            A的成交数量：
      ...
      Answer: () => (
        <span>
          整个市场的拟购买总股数为22000，第10000股价格为48元，则成交价格即为第10000股股票对应的价格：48元。
