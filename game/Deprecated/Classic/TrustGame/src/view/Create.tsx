...
export class Create extends Core.Create<ICreateParams, ICreateState> {
  state: ICreateState = {
    ...
    group: 2,
    groupParams: [
      { initialFunding: 100, magnification: 2 },
      { initialFunding: 100, magnification: 2 }
    ],
    groupSize: 2,
    readonly: true
    ...
    return (
      <div className={style.create}>
        <ul className={style.configFields}>
          ...
          <li>
            <Label label="组数" />
            <RangeInput min={1} max={32} onChange={this.setGroup} value={group} />
          </li>
          <li>
            <Label label="每组人数" />
          ...
          <li>
            <Label label="初始资金" />
            <RangeInput value={initialFunding} onChange={this.setInitialFunding} />
          </li>
          <li>
            <Label label="翻倍比率" />
            <Input value={magnification} onChange={this.setMagnification} />
          </li>
        </ul>
