...
var router = express_1.Router()
    ...
    var gameId, sheetType, game, name, data, option, _a, logs, buffer;
        ...
        switch (_b.label) {
            ...
            case 3:
                ...
                logs.forEach(function (_a) {
                    var _b = _a.data, seatNumber = _b.seatNumber, answers = _b.answers;
                    answers.forEach(function (ans, i) {
                        data.push([seatNumber, i + 1, Controller_1.QUESTION_ANSWERS[i], ans, ans === Controller_1.QUESTION_ANSWERS[i] ? '是' : '否']);
                    });
                });
                return [3 /*break*/, 4];
            case 4:
...
server_1.Server.start(config_1.namespace, Controller_1.Controller, path_1.resolve(__dirname, '../static'), router);
